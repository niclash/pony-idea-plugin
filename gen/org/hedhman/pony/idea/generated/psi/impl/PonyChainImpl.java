...
public class PonyChainImpl extends ASTWrapperPsiElement implements PonyChain {

  public PonyChainImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public PsiElement getChainOp() {
    return findNotNullChildByType(CHAIN_OP);
  }
