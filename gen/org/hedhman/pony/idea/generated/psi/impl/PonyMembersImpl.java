...
public class PonyMembersImpl extends ASTWrapperPsiElement implements PonyMembers {
  ...
  @Override
  @NotNull
  public List<PonyFieldDecl> getFieldDeclList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, PonyFieldDecl.class);
  }

  @Override
  @NotNull
  public List<PonyMethodDecl> getMethodDeclList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, PonyMethodDecl.class);
  }
