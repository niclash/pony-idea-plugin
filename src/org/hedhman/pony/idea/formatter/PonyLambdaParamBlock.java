...
public class PonyLambdaParamBlock extends AbstractPonyBlock
    implements Block
{
    public PonyLambdaParamBlock( @NotNull ASTNode node, @Nullable Alignment alignment, SpacingBuilder spacingBuilder )
    {
