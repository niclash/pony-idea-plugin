...
public class PonyIsOpBlock extends AbstractPonyBlock
    implements Block
{
    public PonyIsOpBlock( @NotNull ASTNode node, @Nullable Alignment alignment, SpacingBuilder spacingBuilder )
    {
