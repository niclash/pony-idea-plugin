...
public class PonyIdSeqBlock extends AbstractPonyBlock
    implements Block
{
    public PonyIdSeqBlock( @NotNull ASTNode node, @Nullable Alignment alignment, SpacingBuilder spacingBuilder )
    {
    ...
    protected List<Block> buildChildren()
    {
        ...
        while( child != null )
        {
            ...
            {
                Block block;
                if( child.getElementType() == PonyTypes.IDSEQ_IN_SEQ )
                {
