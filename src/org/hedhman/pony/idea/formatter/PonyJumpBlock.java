...
public class PonyJumpBlock extends AbstractPonyBlock
    implements Block
{
    public PonyJumpBlock( @NotNull ASTNode node, @Nullable Alignment alignment, SpacingBuilder spacingBuilder )
    {
