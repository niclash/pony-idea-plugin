...
public class PonyIfTypeBlock extends AbstractPonyBlock
    implements Block
{
    public PonyIfTypeBlock( @NotNull ASTNode node, @Nullable Alignment alignment, SpacingBuilder spacingBuilder )
    {
