...
public class PonyElseIfTermBlock extends AbstractPonyBlock
    implements Block
{
    public PonyElseIfTermBlock( @NotNull ASTNode node, @Nullable Alignment alignment, SpacingBuilder spacingBuilder )
    {
