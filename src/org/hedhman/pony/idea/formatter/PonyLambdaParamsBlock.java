...
public class PonyLambdaParamsBlock extends AbstractPonyBlock
    implements Block
{
    public PonyLambdaParamsBlock( @NotNull ASTNode node, @Nullable Alignment alignment, SpacingBuilder spacingBuilder )
    {
    ...
    protected List<Block> buildChildren()
    {
        ...
        while( child != null )
        {
            ...
            {
                Block block;
                if( child.getElementType() == PonyTypes.LAMBDAPARAM )
                {
                    block = new PonyLambdaParamBlock( child, getAlignment(), spacingBuilder );
                }
                else
                {
