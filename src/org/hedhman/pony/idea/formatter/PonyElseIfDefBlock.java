...
public class PonyElseIfDefBlock extends AbstractPonyBlock
    implements Block
{
    public PonyElseIfDefBlock( @NotNull ASTNode node, @Nullable Alignment alignment, SpacingBuilder spacingBuilder )
    {
