...
public class PonyTupleBlock extends AbstractPonyBlock
    implements Block
{
    public PonyTupleBlock( @NotNull ASTNode node, @Nullable Alignment alignment, SpacingBuilder spacingBuilder )
    {
