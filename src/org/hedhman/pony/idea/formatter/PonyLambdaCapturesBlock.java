...
public class PonyLambdaCapturesBlock extends AbstractPonyBlock
    implements Block
{
    public PonyLambdaCapturesBlock( @NotNull ASTNode node, @Nullable Alignment alignment, SpacingBuilder spacingBuilder )
    {
    ...
    protected List<Block> buildChildren()
    {
        ...
        while( child != null )
        {
            ...
            {
                Block block;
                if( child.getElementType() == PonyTypes.LAMBDACAPTURE )
                {
                    block = new PonyLambdaCaptureBlock( child, getAlignment(), spacingBuilder );
                }
                else
                {
