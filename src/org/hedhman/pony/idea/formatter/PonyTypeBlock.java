...
public class PonyTypeBlock extends AbstractPonyBlock
    implements Block
{
    public PonyTypeBlock( @NotNull ASTNode node, @Nullable Alignment alignment, SpacingBuilder spacingBuilder )
    {
    ...
    protected List<Block> buildChildren()
    {
        ...
        while( child != null )
        {
            ...
            {
                Block block;
                if( child.getElementType() == PonyTypes.ATOMTYPE )
                {
                    block = new PonyAtomTypeBlock( child, getAlignment(), spacingBuilder );
                }
