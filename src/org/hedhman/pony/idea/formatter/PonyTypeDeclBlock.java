...
public class PonyTypeDeclBlock extends AbstractPonyBlock
{
    protected PonyTypeDeclBlock( @NotNull ASTNode node, @Nullable Alignment alignment, SpacingBuilder spacingBuilder )
    {
