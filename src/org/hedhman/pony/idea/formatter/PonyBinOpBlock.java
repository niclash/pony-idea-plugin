...
public class PonyBinOpBlock extends AbstractPonyBlock
    implements Block
{
    public PonyBinOpBlock( @NotNull ASTNode node, @Nullable Alignment alignment, SpacingBuilder spacingBuilder )
    {
