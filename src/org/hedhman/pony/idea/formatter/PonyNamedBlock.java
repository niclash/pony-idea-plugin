...
public class PonyNamedBlock extends AbstractPonyBlock
    implements Block
{
    public PonyNamedBlock( @NotNull ASTNode node, @Nullable Alignment alignment, SpacingBuilder spacingBuilder )
    {
    ...
    protected List<Block> buildChildren()
    {
        ...
        while( child != null )
        {
            ...
            {
                Block block;
                if( child.getElementType() == PonyTypes.NAMEDARG )
                {
                    block = new PonyNamedArgBlock( child, getAlignment(), spacingBuilder );
                }
                else
                {
