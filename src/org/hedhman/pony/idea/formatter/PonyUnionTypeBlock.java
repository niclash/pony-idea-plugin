...
public class PonyUnionTypeBlock extends AbstractPonyBlock
    implements Block
{
    public PonyUnionTypeBlock( @NotNull ASTNode node, @Nullable Alignment alignment, SpacingBuilder spacingBuilder )
    {
