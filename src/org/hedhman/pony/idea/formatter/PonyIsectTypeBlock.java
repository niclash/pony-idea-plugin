...
public class PonyIsectTypeBlock extends AbstractPonyBlock
    implements Block
{
    public PonyIsectTypeBlock( @NotNull ASTNode node, @Nullable Alignment alignment, SpacingBuilder spacingBuilder )
    {
