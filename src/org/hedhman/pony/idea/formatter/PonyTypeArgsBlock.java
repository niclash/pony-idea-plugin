...
public class PonyTypeArgsBlock extends AbstractPonyBlock
    implements Block
{
    public PonyTypeArgsBlock( @NotNull ASTNode node, @Nullable Alignment alignment, SpacingBuilder spacingBuilder )
    {
    ...
    protected List<Block> buildChildren()
    {
        ...
        while( child != null )
        {
            ...
            {
                Block block;
                if( child.getElementType() == PonyTypes.TYPEARG )
                {
                    block = new PonyTypeArgBlock( child, getAlignment(), spacingBuilder );
                }
                else
                {
