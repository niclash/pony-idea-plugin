...
public class PonyPositionalBlock extends AbstractPonyBlock
    implements Block
{
    public PonyPositionalBlock( @NotNull ASTNode node, @Nullable Alignment alignment, SpacingBuilder spacingBuilder )
    {
