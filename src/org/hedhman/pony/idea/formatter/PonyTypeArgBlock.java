...
public class PonyTypeArgBlock extends AbstractPonyBlock
    implements Block
{
    public PonyTypeArgBlock( @NotNull ASTNode node, @Nullable Alignment alignment, SpacingBuilder spacingBuilder )
    {
