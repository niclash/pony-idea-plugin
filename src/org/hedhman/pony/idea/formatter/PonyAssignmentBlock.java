...
public class PonyAssignmentBlock extends AbstractPonyBlock
    implements Block
{
    public PonyAssignmentBlock( @NotNull ASTNode node, @Nullable Alignment alignment, SpacingBuilder spacingBuilder )
    {
    ...
    protected List<Block> buildChildren()
    {
        ...
        while( child != null )
        {
            if( handleCommentAndWhitespaceBlock( blocks, child, getAlignment(), spacingBuilder ) )
            {
                ...
                else if( child.getElementType() == PonyTypes.ASSIGNMENT )
                {
                ...
                else if( child.getElementType() == PonyTypes.ASSIGN )
                {
