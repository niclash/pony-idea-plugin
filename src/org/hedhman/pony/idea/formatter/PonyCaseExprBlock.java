...
public class PonyCaseExprBlock extends AbstractPonyBlock
    implements Block
{
    public PonyCaseExprBlock( @NotNull ASTNode node, @Nullable Alignment alignment, SpacingBuilder spacingBuilder )
    {
