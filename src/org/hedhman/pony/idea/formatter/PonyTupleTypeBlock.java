...
public class PonyTupleTypeBlock extends AbstractPonyBlock
    implements Block
{
    public PonyTupleTypeBlock( @NotNull ASTNode node, @Nullable Alignment alignment, SpacingBuilder spacingBuilder )
    {
    ...
    protected List<Block> buildChildren()
    {
        ...
        while( child != null )
        {
            ...
            {
                Block block;
                if( child.getElementType() == PonyTypes.INFIXTYPE )
                {
