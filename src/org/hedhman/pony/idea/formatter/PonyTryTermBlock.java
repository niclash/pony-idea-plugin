...
public class PonyTryTermBlock extends AbstractPonyBlock
    implements Block
{
    public PonyTryTermBlock( @NotNull ASTNode node, @Nullable Alignment alignment, SpacingBuilder spacingBuilder )
    {
