...
public class PonyWithElemBlock extends AbstractPonyBlock
    implements Block
{
    public PonyWithElemBlock( @NotNull ASTNode node, @Nullable Alignment alignment, SpacingBuilder spacingBuilder )
    {
    ...
    protected List<Block> buildChildren()
    {
        ...
        while( child != null )
        {
            ...
            {
                Block block;
                if( child.getElementType() == PonyTypes.IDSEQ )
                {
