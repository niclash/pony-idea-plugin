...
public class PonyHashTermBlock extends AbstractPonyBlock
    implements Block
{
    public PonyHashTermBlock( @NotNull ASTNode node, @Nullable Alignment alignment, SpacingBuilder spacingBuilder )
    {
    ...
    protected List<Block> buildChildren()
    {
        ...
        while( child != null )
        {
            ...
            {
                Block block;
                if( child.getElementType() == PonyTypes.POSTFIX )
                {
