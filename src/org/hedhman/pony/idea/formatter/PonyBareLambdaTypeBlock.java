...
public class PonyBareLambdaTypeBlock extends AbstractPonyBlock
    implements Block
{
    public PonyBareLambdaTypeBlock( @NotNull ASTNode node, @Nullable Alignment alignment, SpacingBuilder spacingBuilder )
    {
