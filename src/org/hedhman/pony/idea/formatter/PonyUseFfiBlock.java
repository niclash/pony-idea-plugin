...
public class PonyUseFfiBlock extends AbstractPonyBlock
    implements Block
{
    public PonyUseFfiBlock( @NotNull ASTNode node, @Nullable Alignment alignment, SpacingBuilder spacingBuilder )
    {
    ...
    protected List<Block> buildChildren()
    {
        ...
        while( child != null )
        {
            ...
            {
                Block block;
                if( child.getElementType() == PonyTypes.FFI_DECL )
                {
