...
public class PonyParserDefinition implements ParserDefinition
{
    ...
    public static final TokenSet COMMENTS = TokenSet.create( PonyTypes.COMMENT );

    public static final IFileElementType FILE = new IFileElementType( PonyLanguage.INSTANCE );

//    public static IElementType createType( String debugName )
//    {
//        return new PonyElementType( debugName );
//    }
//
//    public static IElementType createTokenType( String debugName )
//    {
//        return new PonyTokenType( debugName );
//    }
